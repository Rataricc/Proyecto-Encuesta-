...
urlpatterns = [
    ...
    path('Usuarios/', include('apps.user.urls')), # Usuarios url de la aplicacion... 
    ...
    path('Preguntas/', include('apps.preguntas.urls'))                                                                # de otras clase o nose como decirlo bien... tengo que seguir.
]